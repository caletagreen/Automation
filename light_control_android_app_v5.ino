/* www.caletagreen.com
   ...
   Store in EEPROM the start time and the end time for light control
...
void check_time(){
    ...
    String api_key_on = String("1njciv"); // api_key to lights on, obtained from m2mlight.com
    String api_key_off = String("1njciw"); // api_key to lights off, obtained from m2mlight.com
