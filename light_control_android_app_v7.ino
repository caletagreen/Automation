...
EthernetServer server(9065);                           // arduino server port
...
char api_key_on[] = "8acP1njchu"; // api_key to lights on, obtained from m2mlight.com
char api_key_off[] = "DmNt1njchv"; // api_key to lights off, obtained from m2mlight.com
