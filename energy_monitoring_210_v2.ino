...
void loop() {   
   ...
   String api_key1 = String("883YszrStin"); // Voltage
   String api_key2 = String("514EUmWZfnB"); // Cooker real power
   String api_key3 = String("102OjcBi0AQ"); // Current phase 1
   String api_key4 = String("141itawqPLz"); // Current phase 2
   String api_key5 = String("193vnsWkQpz"); // Total real power
