...
void loop() {   
   ...
   String api_key1 = String("xxxxxxxx"); // Voltage
   String api_key2 = String("xxxxxxxx"); // Cooker real power
   String api_key3 = String("xxxxxxxx"); // Current phase 1
   String api_key4 = String("xxxxxxxx"); // Current phase 2
   String api_key5 = String("xxxxxxxx"); // Total real power
