/* www.caletagreen.com
   ...
   This version V2 uses the m2mdata arduino library
...
void check_time(){
    ...
    String api_key_on = String("180SgN4pHk"); // api_key to lights on, obtained from m2mlight.com
    String api_key_off = String("19uhLDYA2Z"); // api_key to lights off, obtained from m2mlight.com
