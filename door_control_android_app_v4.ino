/* www.caletagreen.com
   ...
   2. Sound alarm when photobean is broken and send N alert email
   ...
   First, define actuators and alert on m2mlight.com and obtain api_key identifiers
...
EthernetServer server(8092);                           // arduino server port
