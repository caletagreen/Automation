...
void loop() {   
   ...
   String api_key_tank = String("1FEUqLOfi");
   String api_key_heater = String("4nGTZiA0H");
   String api_key_inverter = String("3TLKMcHWf");
   String api_key_irms = String("29HRJr5AaF");

   // Define alert api_key variable obtained from m2mlight.com
   String api_key_alert = String("16o0pik3Oa");
